...
export const getAllLegendsSquadrons = async (req, res, next) => {
  ...
  const filePath = path.join(__dirname, '../public/converted-json/old-legends-squadrons/legends-squadrons.json');
...
export const getLegendsSquadronById = async (req, res, next) => {
  ...
  const filePath = path.join(__dirname, `../public/converted-json/old-legends-squadrons/${squadronId}.json`);
