...
import nexusShipRoutes from './routes/nexusShipRoutes.js';
import nexusSquadronRoutes from './routes/nexusSquadronRoutes.js';
import nexusUpgradeRoutes from './routes/nexusUpgradeRoutes.js';
...
import legacyBetaShipRoutes from './routes/legacyBetaShipRoutes.js';
import legacyBetaSquadronRoutes from './routes/legacyBetaSquadronRoutes.js';
import legacyBetaUpgradeRoutes from './routes/legacyBetaUpgradeRoutes.js';
...
app.use('/nexus/ships', nexusShipRoutes);
app.use('/nexus/squadrons', nexusSquadronRoutes);
app.use('/nexus/upgrades', nexusUpgradeRoutes);
...
app.use('/legacy-beta/ships', legacyBetaShipRoutes);
app.use('/legacy-beta/squadrons', legacyBetaSquadronRoutes);
app.use('/legacy-beta/upgrades', legacyBetaUpgradeRoutes);
