        ...
        try {
          ...
          for (let i = 0; i < lines.length; i++) {
            if (lines[i].includes('"flagship":')) {
              ...
              const nextLine = `${indentation}"complex_restrictions": "",`;
              if (!lines[i + 1].includes('"complex_restrictions":')) {
...
// Main execution
console.log('Adding complex_restrictions to upgrade JSON files...');
